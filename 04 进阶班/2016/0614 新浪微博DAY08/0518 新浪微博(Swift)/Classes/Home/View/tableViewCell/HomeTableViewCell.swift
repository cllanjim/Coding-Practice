...
class HomeTableViewCell: UITableViewCell {
    ...
    var viewModel: StatusViewModel? {
        didSet{
            ...
            contentTextLabel.attributedText = SQKeyBoardEmoticonPackage.shareInstance.attributedStringWithString(viewModel!.statusModel.text ?? "", font: contentTextLabel.font)
