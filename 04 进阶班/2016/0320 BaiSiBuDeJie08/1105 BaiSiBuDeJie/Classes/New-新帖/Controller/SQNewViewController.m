...
- (void)viewDidLoad {
    ...
    self.navigationItem.leftBarButtonItem = [UIBarButtonItem sq_itemWithImage:@"MainTagSubIcon" highImage:@"MainTagSubIconClick" target:self action:@selector(buttonClick)];
