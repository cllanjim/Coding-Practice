...
static NSString * const ID = @"meCell";
...
- (void)setNavegationBar{
    ...
    UIBarButtonItem *settingItem = [UIBarButtonItem sq_itemWithImage:@"mine-setting-icon" highImage:@"mine-setting-icon-click" target:self action:@selector(settingClick)];
    
    UIBarButtonItem *moonItem = [UIBarButtonItem sq_itemWithImage:@"mine-moon-icon" highImage:@"mine-moon-icon-click" target:self action:@selector(moonClick)];
