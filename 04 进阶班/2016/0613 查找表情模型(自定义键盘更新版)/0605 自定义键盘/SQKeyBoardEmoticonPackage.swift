...
extension SQKeyBoardEmoticonPackage {
    ...
    /**
     ...
     - returns: 带表情图片的属性字符串
     */
    func attributedStringWithString(str: String) -> NSAttributedString? {
        ...
        while index > 0 {
            ...
            let attrStr: NSAttributedString  = SQKeyboardEmoticonAttachment.attributedStringWithEmoticonModel(emoticonModel, font: UIFont.systemFontOfSize(15))
