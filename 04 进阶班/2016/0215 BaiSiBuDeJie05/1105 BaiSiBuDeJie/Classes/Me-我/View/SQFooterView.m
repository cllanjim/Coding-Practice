...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self != nil) {
        ...
        [sessionManager GET:@"http://api.budejie.com/api/api_open.php" parameters:parameter progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
//            //查看返回的JSON数据
//            SQLOG(@"请求成功");
//            //查看返回数据
//            //方法一 打印数据
...
//            NSLog(@"%@",responseObject[@"square_list"]);
            ...
            [self createInterfaceWithModelArray:classOfModel];
