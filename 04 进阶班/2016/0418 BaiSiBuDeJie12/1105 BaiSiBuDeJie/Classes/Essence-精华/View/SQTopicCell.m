...
- (SQTopicPictureView *)pictureView{
    if (!_pictureView) {
        SQTopicPictureView *pictureView = [SQTopicPictureView sq_viewFromXib];
...
- (SQTopicVideoView *)videoView{
    if (!_videoView) {
        SQTopicVideoView *videoView = [SQTopicVideoView sq_viewFromXib];
...
- (SQTopicVoiceView *)voiceView{
    if(!_voiceView){
        SQTopicVoiceView *voiceView = [SQTopicVoiceView sq_viewFromXib];
...
- (void)setTopicModel:(SQTopicModel *)topicModel{
    ...
    //设置头像
    [self.profileImageView sq_setHeader:topicModel.profile_image];
