...
//    /// 监听注册按钮点击
//    func visitorViewDidRegisterBtnClick(visitor: VisitorView);
//    /// 监听登录按钮点击
//    func visitorViewDidLoginBtnClick(visitor: VisitorView);
//}
...
//        registerButton.addTarget(self, action: #selector(VisitorView.registerButtonOnClick), forControlEvents: .TouchUpInside)
//        loginButton.addTarget(self, action: #selector(VisitorView.loginButtonOnClick), forControlEvents: .TouchUpInside)
    }
...
//        delegate?.visitorViewDidLoginBtnClick(self)
//    }
