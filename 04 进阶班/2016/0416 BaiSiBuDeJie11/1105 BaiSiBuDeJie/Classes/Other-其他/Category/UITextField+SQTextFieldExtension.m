...
- (void)setSq_PlaceholderColor:(UIColor *)sq_placeholderColor{
    ...
    if (sq_placeholderColor == nil) {
        sq_placeholderColor = [UIColor colorWithRed:0 green:0 blue:0.0980392 alpha:0.22];
    }
    
    //设置placeholderColor的颜色
    [self setValue:sq_placeholderColor forKeyPath:SQPlaceholderColorKey];
}

- (UIColor *)sq_placeholderColor{
