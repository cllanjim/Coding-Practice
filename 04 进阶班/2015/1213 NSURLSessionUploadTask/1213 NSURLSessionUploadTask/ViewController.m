...
//    path = [path stringByAppendingPathComponent:@"Snip20151213_14.png"];
//    NSURL *fileURL = [NSURL URLWithString:path];
//    NSLog(@"%@", path);
//    NSURL *fileURL = [NSURL fileURLWithPath:@"/Users/SketchK/Desktop/Snip20151209_7.png"];
//    NSLog(@"%@",fileURL);
