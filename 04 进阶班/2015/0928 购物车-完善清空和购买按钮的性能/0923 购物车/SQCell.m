...
- (IBAction)minusClick:(id)sender {
    ...
    if ([self.delegate respondsToSelector:@selector(sqcelldidClickMinusButton:)]) {
        [self.delegate sqcelldidClickMinusButton:self];
    }
...
- (IBAction)addClick:(id)sender {
    ...
    if ([self.delegate respondsToSelector:@selector(sqcelldidClickPlusButton:)]) {
        [self.delegate sqcelldidClickPlusButton:self];
    }
